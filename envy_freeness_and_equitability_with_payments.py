...
def calcuSWave(allocation: dict, evaluation: dict):
    ...
    7.5
    >>> calcuSWave(allocation_4, eval_4)
    20.5
    """
    sum_values = 0
...
def envy_freeness_and_equitability_with_payments(allocation: dict, evaluation: dict):
    ...
    >>> envy_freeness_and_equitability_with_payments(evaluation = eval_1, allocation = allocation_1)
    "allocation: {'a': ['y', 'x', 'r'], 'b': []}, payments: {'a': 50.0, 'b': -50.0}"
    >>> eval_2 = {"A":{"x":70},"B":{"x":60},"C":{"x":40},"D":{"x":80},"E":{"x":55}}
    >>> allocation_2 = {"A": ["x"], "B": [], "C": [], "D": [], "E": []}
    >>> envy_freeness_and_equitability_with_payments(evaluation = eval_2, allocation = allocation_2)
    ...
    >>> envy_freeness_and_equitability_with_payments(evaluation = eval_3, allocation = allocation_3)
    ...
    >>> envy_freeness_and_equitability_with_payments(evaluation = eval_4, allocation = allocation_4)
