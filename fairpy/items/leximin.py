...
def leximin_optimal_allocation(instance: Any, allocation_constraint_function=None, **solver_options) -> Allocation:
    """
...
@convert_input_to_valuation_matrix
def leximin_optimal_envyfree_allocation(instance: Any, allocation_constraint_function=None, **solver_options) -> Allocation:
    """
    ...
    The allocation should maximize the leximin vector of utilities.
    >>> logger.setLevel(logging.WARNING)
    >>> a = leximin_optimal_envyfree_allocation([[5,0],[3,3]]).round(2)
    >>> a
    Agent #0 gets { 75.0% of 0} with value 3.75.
    Agent #1 gets { 25.0% of 0, 100.0% of 1} with value 3.75.
    <BLANKLINE>
    ...
    array([3.75, 3.75])
    >>> v = [[3,0],[5,5]]
    >>> print(leximin_optimal_envyfree_allocation(v).round(3).utility_profile())
    [3. 5.]
    >>> v = [[5,5],[3,0]]
    >>> print(leximin_optimal_envyfree_allocation(v).round(3).utility_profile())
    [5. 3.]
