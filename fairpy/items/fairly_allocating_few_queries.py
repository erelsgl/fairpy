...
def two_agents_ef1(agents: List[Agent]) -> Allocation:
    """
    Algorithm No 1
...
def three_agents_IAV(agents: List[Agent]) -> Allocation:
    """
    ...
    >>> allocation = three_agents_IAV([Alice,Bob,George])
    >>> allocation
...
def three_agents_AAV(agents: List[Agent]) -> Allocation:
    """
