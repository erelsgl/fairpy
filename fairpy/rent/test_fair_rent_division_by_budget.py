...
class TestMain(unittest.TestCase):
    ...
    def test_algo2(self):
        ...
        self.assertEqual(optimal_envy_free(ex6, 1000, {'Alice': 500, 'Bob': 600}), "no solution")
        ...
        self.assertEqual(optimal_envy_free(ex8, 2500, {
            'a': 400, 'b': 400,
            'c': 400, 'd': 400,
            'e': 400, 'f': 400,
            'g': 400, 'h': 400,
        ...
        self.assertEqual(optimal_envy_free(ex9, 5500, {
            'a': 1000, 'b': 1000,
            'c': 1000, 'd': 1000,
            'e': 1000, 'f': 1000,
            'g': 1000, 'h': 1000,
